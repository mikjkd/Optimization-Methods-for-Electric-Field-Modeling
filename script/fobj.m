...
fo =  @(lmbd1) (1/mean(Etot(P,xc,yc,[lambda(1),lambda(2),lambda(3),lambda(4)])))*...
       sqrt((xb-xa)/length(xc))*norm( Etot(P,xc,yc,[lambda(1),lambda(2),lambda(3),lambda(4)]) - Etot(P,xc,yc,[lambda(1),lmbd1,lambda(3),lambda(4)]))
