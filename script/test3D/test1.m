...
test_params = struct( ...
    ...
    'tolerance', 1e-12, ...
    'minLength', 1e-10, ...
    'start_point', [0.5e-06 5.45e-07 1e-08], ...
    'length', 1e-6...
);
...
f2 =@(lmbd2,lmbd3,lmbd4)(1/mean(Edesideratax))* sqrt((xb-xa)/length(xc))* norm(Edesideratax - Etotx(P,xc,yc,[lambda(1),lmbd2,lmbd3,lmbd4]));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
range = struct('Xmin', 0e-06, 'Xmax', 1e-06, 'Ymin', 0e-06, 'Ymax', 1e-06,'Zmin', 0e-06, 'Zmax', 1e-06);
