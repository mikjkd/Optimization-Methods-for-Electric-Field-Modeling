...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Edesiderata costante kx^2
Edesideratax = (9.599999999999997e+07).*(xc.^3);
...
fo =@(lmbd) (1/abs(mean(Edesideratax)))* sqrt(1/length(xc))* norm(Edesideratax - Etotx(P,xc,yc,[lambda(1),lambda(2),lmbd(1),lambda(4)]));
%f1 dipende da due variabili (lmbd1,lmbd2)
f1 =@(lmbd) (1/abs(mean(Edesideratax)))* sqrt(1/length(xc))* norm(Edesideratax - Etotx(P,xc,yc,[lambda(1),lmbd(1),lmbd(2),lambda(4)]));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
